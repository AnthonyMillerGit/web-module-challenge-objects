...
createMenuItem('oatmeal',3,'breakfast')
createMenuItem('smoothie',8,'drinks')
console.log(createMenuItem('pizza',5,'lunch'))
console.log(createMenuItem('oatmeal',3,'breakfast'))
...
reviews.push({name: "anthony", rating: 2, feedback: "it was ok"})
console.log(reviews)
